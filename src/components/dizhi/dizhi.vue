<template>
   ...
   <div class="showChose" v-show="!showChose">
      <div class="dialog_rgba_bg" @click="close_layer"></div>
    <transition name="move">  
      <section class="address">
        <section class="title">
          ...
          <p class="close_icon" @click="close_layer"></p>
        </section>
        <section class="title_list">
          <div class="area" @click="provinceSelected()">{{Province?Province:info[province].name}}</div>
        ...
        <ul>
          <li class="addList" v-for="(v,k) in info" :key="v.name" @click="getProvinceId(v.id, v.name, k)" v-show="showProvince" :class="v.selected ? 'active' : ''">{{v.name}}</li>
          <li class="addList" v-for="(v,k) in showCityList" :key="v.id" @click="getCityId(v.id, v.name, k)" v-show="showCity" :class="v.selected ? 'active' : ''">{{v.name}}</li>
          <li class="addList" v-for="(v,k) in showDistrictList" :key="v.name" @click="getDistrictId(v.id, v.name, k)" v-show="showDistrict" :class="v.selected ? 'active' : ''">{{v.name}}</li>
        </ul>
       </section>
      </transition>
   </div>
...
export default {
  ...
  methods: {
    ...
    //   Province: false,
    //   City: false,
      let infos=this.Province+" "+this.City+" "+this.District;
